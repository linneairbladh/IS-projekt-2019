...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		controller.updateCourseName("C56579", "Code"); 	
		System.out.println("Nytt namn är " + controller.getCourseName("C56579")); 
		
		//Testar om det går att lägga till ett prov
		String addExam = controller.addWrittenExam("C56579", "E02863", "09:00", "Room A123", "02/03-20");
		...
		controller.removeWrittenExam(addExam);
